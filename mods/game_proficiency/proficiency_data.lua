...
function ProficiencyData:getWeaponProfessionType(displayItem)
	...
	-- getWeaponType may not exist in this client version
	local success, weaponType = pcall(function() return displayItem:getWeaponType() end)
	if success and weaponType == WEAPON_CROSSBOW then
		return "crossbow"
	end
	return "regular"
end
