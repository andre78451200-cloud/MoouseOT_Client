...
function addDoubleToggleButton(id, description, image, callback, front, index)
    -- Cria um botão duplo (42x20) que ocupa espaço de 2 ícones no painel specials
    local panel = optionsController.ui.onPanel.specials
    specialsAmount = specialsAmount + 2 -- Conta como 2 botões
