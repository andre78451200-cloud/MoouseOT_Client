return {
    ...
    showActionbar                     = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            if not modules.game_actionbar or not modules.game_actionbar.setActionBarVisible then return end
            modules.game_actionbar.setActionBarVisible(value)
        end
    },
    minimapFloatingWindow             = {
        value = false,
        action = function(value, options, controller, panels, extraWidgets)
            if modules.game_minimap and modules.game_minimap.setMinimapFloatingMode then
                modules.game_minimap.setMinimapFloatingMode(value)
            end
        end
    },
    ...
    graphicalCooldown = {
        ...
        action = function(value)
            if not modules.game_actionbar or not modules.game_actionbar.toggleCooldownOption then return end
    ...
    actionBarShowBottom1 = {
        value = true,
        action = function(value)
            if not modules.game_actionbar or not modules.game_actionbar.configureActionBar then return end
    ...
    allActionBar46 = {
        value = false,
        action = function(value)
            if not modules.game_actionbar or not modules.game_actionbar.configureActionBar or not panels.actionbars then return end
    ...
    actionTooltip = {
        value = true,
        action = function(value)
            if not modules.game_actionbar or not modules.game_actionbar.updateVisibleOptions then return end
