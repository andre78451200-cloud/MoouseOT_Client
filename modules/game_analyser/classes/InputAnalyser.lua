...
function onInputExtra(mousePosition)
  ...
  local sourceVisible = InputAnalyser.window.contentsPanel.damageSource:isVisible()
	...
	menu:addSeparator()
	menu:addCheckBox(tr('Show Damage Graph'), graphVisible, function() InputAnalyser:setDamageGraph(not graphVisible, true) end)
	menu:addCheckBox(tr('Show Damage Types'), typesVisible, function() InputAnalyser:setDamageTypes(not typesVisible, true) end)
	menu:addCheckBox(tr('Show Damage Sources'), sourceVisible, function() InputAnalyser:setDamageSource(not sourceVisible, true) end)
	menu:addSeparator()
