...
function BossCooldown:checkTicks()
	...
	for _, widget in ipairs(self.widgets) do
		...
		if widget.tick <= 0 then
			...
			widget.bossNCooldown:setColor('green')
		...
		elseif widget.tick <= 60 then
			...
			widget.bossNCooldown:setColor('orange')
...
function onBossExtra(mousePosition)
	...
	menu:addCheckBox(tr('sort by cooldown'), BossCooldown.sort == 0, function()
		BossCooldown.sort = 0
		BossCooldown:updateWindow()
	end)
	menu:addCheckBox(tr('sort by name'), BossCooldown.sort == 1, function()
		BossCooldown.sort = 1
		BossCooldown:updateWindow()
	end)
...
function toggleBossCDFocus(visible)
	...
	elseif widget then
		...
		widget.onClick = function() modules.game_interface.toggleInternalFocus(); toggleBossCDFocus(not visible) end
	end
