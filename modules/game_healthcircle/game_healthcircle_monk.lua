...
function checkMonkVocation()
    ...
    -- Check if player is Monk by vocation
...
function positionMonkWidgets()
    if not isMonkMode or not monkCircleBackground or not healthCircle then
        return
    end
