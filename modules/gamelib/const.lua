...
-- Additional MAPMARK constants for worldmap
MAPMARK_MISSION_COMPLETE = 1
MAPMARK_MISSION_AVAILABLE = 2
MAPMARK_SEAPORT = 3
MAPMARK_TRADEPOST = 4
MAPMARK_CRAFTING_STATION = 6
MAPMARK_DYNAMICEVENT = 7
MAPMARK_REGION_CONFLICT = 8
MAPMARK_LAND = 9
MAPMARK_MURDERER = 10
MAPMARK_TRADEPACK = 11
MAPMARK_FORT = 12
MAPMARK_STRONGHOLD = 13
MAPMARK_PVP_ARENA = 17
MAPMARK_PARTY_MEMBER = 18
MAPMARK_COMPASS = 19
...
-- Additional profession constants for worldmap
ProfessionBlacksmithing = 1
ProfessionCarpentry = 4
ProfessionCooking = 5
ProfessionWeaving = 7

-- Profession names for worldmap
ProfessionNames = {
...
-- Region name to ID mapping for worldmap
RegionNameToId = {}
